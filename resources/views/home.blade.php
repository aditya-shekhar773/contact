...
<body>
    <div class='w-full flex bg-slate-100  h-auto'>
        ...
        <div class='w-4/5 sticky top-0'>
                        ...
                        <ul class='flex space-x-6 mt-2'>
                            ...
                            <li class=''>
                               <a href="{{route('auth.logout')}}">
                                 <img class="gb_h gbii rounded-full" src="https://lh3.googleusercontent.com/ogw/AAEL6shkA6LZJmVcmLhF5QAn_1PtQPRTxCi2kptMiHRWMQ=s32-c-mo" srcset="https://lh3.googleusercontent.com/ogw/AAEL6shkA6LZJmVcmLhF5QAn_1PtQPRTxCi2kptMiHRWMQ=s32-c-mo 1x, https://lh3.googleusercontent.com/ogw/AAEL6shkA6LZJmVcmLhF5QAn_1PtQPRTxCi2kptMiHRWMQ=s64-c-mo 2x " alt="" aria-hidden="true" data-noaft=""> 
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class='w-full flex flex-col justify-between items-center p-4 overflow-y-scroll sc h-220'>
                @if (session()->has('msg'))
                    <div class="bg-{{session('bg')}}-500 text-white px-4 py-2 rounded">
                        {{session('msg')}}
                    </div>
                @endif
                <table class='w-full'>
                    
                    <thead class='border-b border-slate-300 fixTableHead  relative'>
                        <tr class='h-16'>
                            <th class="text-slate-100">id</th>
                            <th>Name</th>
                            <th>Email</th>
                            <th>Phone number</th>
